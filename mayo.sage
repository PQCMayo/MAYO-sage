...
def bitsliced_mul_add(In, a, Out):
    ...
    a0, a1, a2, a3 = map(int, a.list()) # This fails due to "AttributeError: 'sage.rings.finite_rings.element_givaro.FiniteField_givaroElement' object has no attribute 'list'" It is also not iterable
